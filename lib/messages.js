...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      Reach us on ${chalk.cyan('hello@penateam.com')}
  `
}
...
For example:
  ...
  ${chalk.cyan(program.name)} ${chalk.green('my-pena-app')}
...
exports.start = function (projectName) {
  ...
  Reach us on ${chalk.green('hello@penateam.com')}
`
}
